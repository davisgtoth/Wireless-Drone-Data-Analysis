...
for file in in_files:
    ...
    for i, my_list in enumerate([supply_volt, supply_max, supply_min, tx_current, current_freq, tx_amplitude, 
                                 tx_frequency, rx_average, rx_rms, rx_max, rx_min, rx_frequency]):
